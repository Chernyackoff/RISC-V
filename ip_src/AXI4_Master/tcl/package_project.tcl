...
ipx::package_project -root_dir $IP_PATH/AXI_Master -vendor xilinx.com -library user -taxonomy /UserIP -import_files -set_current false

ipx::unload_core $IP_PATH/AXI_Master/component.xml
ipx::edit_ip_in_project -upgrade true -name tmp_edit_project -directory C:/Homework/Master_Degree/Term2/SoC/SoC_RISC_V/ip/AXI_Master c:/Homework/Master_Degree/Term2/SoC/SoC_RISC_V/ip/AXI_Master/component.xml
