...
ipx::package_project -root_dir $IP_PATH/Processor -vendor SUAI -library user -taxonomy /UserIP -import_files -set_current false

ipx::unload_core $IP_PATH/Processor/component.xml
ipx::edit_ip_in_project -upgrade true -name tmp_edit_project -directory $IP_PATH/Processor $IP_PATH/Processor/component.xml
...
set_property name Processor [ipx::current_core]
